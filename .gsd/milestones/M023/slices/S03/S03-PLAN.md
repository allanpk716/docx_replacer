...
- [x] **T01: Add JWT session auth — login endpoint and middleware update** `est:1h`
...
- [x] **T02: Scaffold Vue 3 + Vite frontend with login page** `est:1.5h`
...
- [x] **T03: Build app management pages — list, versions, upload, promote, delete** `est:1.5h`
...
- [x] **T04: Wire Go embed + SPA handler and verify full integration** `est:1h`
