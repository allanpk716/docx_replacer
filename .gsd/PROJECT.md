...
- **M006-rj9bue**: E2E 回归测试 — 用真实业务数据（LD68/FD68 IVDR.xlsx + 43 个 Word 模板）创建独立 E2E 测试项目，覆盖替换正确性、表格结构、富文本保留、页眉页脚替换、批注追踪五个维度，通过 d81cd00 基准跨版本验证
...
- **E2E 测试**: 独立 xUnit 项目，ServiceFactory DI 条件注册跨版本兼容，TestDataHelper 向上导航查找测试数据
...
- [x] M006-rj9bue: 真实数据端到端回归测试
  - [x] S01: E2E 测试基础设施 + 基本替换验证
  - [x] S02: 两列/三列格式 + 结构验证
  - [x] S03: d81cd00 基准跨版本验证
